    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserOrganisation", x => new { x.userId, x.orgId });
                    table.ForeignKey(
                        name: "FK_UserOrganisation_AspNetUsers_userId",
                        column: x => x.userId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserOrganisation_Organization_orgId",
                        column: x => x.orgId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserOrganisation_orgId",
